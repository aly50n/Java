...
public class Main {
    ...
    static private Prontuario cadastrar(){
        ...
        p.getFuncionario().setCrm(JOptionPane.showInputDialog(null, "CRM/COREN do Funcionario que atendeu o paciente: ", "Atendendo", JOptionPane.QUESTION_MESSAGE));
