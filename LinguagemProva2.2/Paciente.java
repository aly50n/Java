...
public class Paciente extends Pessoa{
    ...
    public void mostrar(Prontuario prontuario){
        ...
        "\nData de Nascimento"+prontuario.getFuncionario().getDataNasc()+"\nFuncao:"+prontuario.getFuncionario().getFuncao()+"      CRM/COREN: "+prontuario.getFuncionario().getCrm()+prontuario.getFuncionario().getCoren()
